		...
		// Preloader
      	...
      	$(window).load(function() {
      		$(".preloader").fadeOut("slow", function(){
				...
				$('.hi .detail')
					.typeTo("I'm Robert. I'm a master student in Information System at Drexel University. I'm passionate about utilizing technology to build amazing products. I have a wide range of background in developer, product manager and entrepreneur.");
      		});
		});
